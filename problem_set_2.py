...
def weather_helper():
    ...
    """
    temperature = int(input("Please enter the current temperature in Farenheit: "))
    ...
    if temperature < 40:
        ...
        if snowing == "yes" or snowing =="yeah" or snowing =="yup":
            jacket = input("Are you wearing jacket?").lower()
          ...
          if raining == "yes" or raining =="yeah" or raining =="yup":
            umbrella = input("Do you have an umbrella with you?").lower()
            if umbrella == "yes" or umbrella == "yeah" or umbrella == "yup":
                print("Good job staying dry!")
            else:
                print("You must enjoy getting wet!")
    elif temperature > 90:
        air_conditioning = input("Do you turn on the air conditioning?").lower()
